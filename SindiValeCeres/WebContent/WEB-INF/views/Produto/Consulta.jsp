...
<div class="btn-group">
						<a href="/SindiValeCeres/Produto/Cadastro"
							...
							<tr>
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<li><a download="download"
												href="<%out.print(obj[3]);%>"> 
													<i class="fa fa-edit"></i> Baixar Imagem
											</a></li>
											<li><a
												href="/SindiValeCeres/Produto/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/SindiValeCeres/Produto/Excluir?id=<%out.print(obj[0]);%>">
