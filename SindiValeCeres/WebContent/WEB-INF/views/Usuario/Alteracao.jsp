...
<%@page import="br.com.sindivaleceres.daoGenericos.UsuarioDao"%>
<%@page import="br.com.sindivaleceres.entity.Usuario"%>
...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/SindiValeCeres/Usuario/Consulta">Consulta</a>
				<i class="fa fa-circle"></i></li>
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/SindiValeCeres/Usuario/Salvar"
