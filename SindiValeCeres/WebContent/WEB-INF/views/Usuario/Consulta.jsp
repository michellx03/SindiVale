...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			<li><a href="/SindiValeCeres/dashboard/index">Dashboard</a>
		...
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				<div class="portlet-title">
					...
					%>
					<div class="btn-group">
						<a href="/SindiValeCeres/Usuario/Cadastro"
				...
				<div class="portlet-body">
					<table class="table table-striped table-bordered table-hover"
						...
						<thead>
							<tr>
								<th style="width: 47px !important;">ID Usuario</th>
								<th>Login</th>
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT  usua_id,usua_usuario FROM controle_acesso.usuario");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/SindiValeCeres/Usuario/Alteracao?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/SindiValeCeres/Usuario/Excluir?id=<%out.print(obj[0]);%>">
...
<t:master>
 ...
 <link
			href="/SindiValeCeres/assets/global/plugins/datatables/datatables.min.css"
			rel="stylesheet" type="text/css" />
        <link
			href="/SindiValeCeres/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css"
			rel="stylesheet" type="text/css" />
        <link
			href="/SindiValeCeres/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css"
			rel="stylesheet" type="text/css" />
...
<script src="/SindiValeCeres/assets/global/scripts/datatable.js"
			type="text/javascript"></script>
        <script
			src="/SindiValeCeres/assets/global/plugins/datatables/datatables.min.js"
			type="text/javascript"></script>
        <script
			src="/SindiValeCeres/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js"
			type="text/javascript"></script>
        <script
...
<script
			src="/SindiValeCeres/assets/pages/scripts/table-datatables-buttons.min.js"
			type="text/javascript"></script>
